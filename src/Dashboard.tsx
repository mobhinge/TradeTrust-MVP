    ...
    <div className="h-screen bg-gray-50 flex overflow-hidden">
      ...
      <div className="w-72 bg-slate-900 text-white flex flex-col shadow-xl">
        <div className="p-3 border-b border-slate-700">
          ...
          {hasUnsavedChanges && (
            <div className="mt-2.5 flex items-center gap-2 text-xs text-yellow-400 bg-yellow-400 bg-opacity-10 px-2 py-1 rounded">
        ...
        <div className="flex-1 p-3 overflow-y-auto">
          <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2.5">System Activity</h3>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="bg-white border-b border-gray-200 px-5 py-2.5 flex-shrink-0">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-bold text-gray-900 mb-0.5">Forensic Strategy Audit</h2>
                <div className="flex items-center gap-2 text-gray-600">
                  <Activity className="w-3.5 h-3.5" />
                  <span className="text-sm">joesplumbing-chicago.com</span>
                </div>
              </div>
              <div className="flex items-center gap-2 bg-green-50 border border-green-200 px-2.5 py-1.5 rounded-lg">
            ...
            <div className="max-w-7xl mx-auto space-y-2.5">
              ...
              {(visibleCards.filter || visibleCards.publishers) && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-2.5">
                  ...
                  {visibleCards.filter && (
                    <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-2.5 animate-fadeIn">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="group relative">
                          ...
                          <div className="absolute right-0 top-6 w-44 bg-gray-900 text-white text-xs rounded p-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                            Block low-quality traffic by filtering out these search terms
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-wrap gap-1.5 mb-2 min-h-[50px]">
                        {allKeywords.map((kw) => {
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-2.5 animate-fadeIn">
                      ...
                      <div className="space-y-1.5">
                        {publishers.map((pub) => (
                          ...
                          >
                            <span className="text-xs font-medium text-gray-700 truncate max-w-[140px] text-left">{pub.name}</span>
                        ...
                        <button className="w-full mt-1 py-1 border border-dashed border-gray-300 rounded text-xs text-gray-400 hover:text-gray-600 hover:border-gray-400 hover:bg-gray-50 transition-all flex items-center justify-center gap-1">
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-2.5">
                      <div className="flex gap-2.5">
                        <div className={`relative overflow-hidden rounded-md flex-shrink-0 transition-all ${
                          previewMode === 'mobile' ? 'w-14 h-14' : 'w-16 h-16'
                        }`}>
                          <img 
                            src={contractorImage}
                            alt="Contractor" 
                        ...
                        <div className="flex-1">
                          ...
                          <p className={`text-gray-700 mb-1.5 leading-snug ${
                            previewMode === 'mobile' ? 'text-xs' : 'text-xs'
                          }`}>
                            Verified Bonded & Insured. Don't risk DIY failures. Serving Zip 60614.
                          </p>
                          <div className="flex items-center gap-1.5">
                            <span className="text-[10px] text-gray-400 uppercase tracking-wide font-semibold">Sponsored</span>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5">
                    ...
                    <div className="text-center p-2 bg-green-50 border border-green-100 rounded-lg shadow-sm flex flex-col justify-center">
                      ...
                      <div className="text-xs font-bold text-green-800 mt-1 flex items-center justify-center gap-1 group relative cursor-help">
                        ...
                        <div className="absolute bottom-full mb-2 w-36 bg-slate-900 text-white text-[10px] p-1.5 rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-20 font-normal">
                          Filtering clicks lacking GPS verification.
                        </div>
                      </div>
                      <div className="text-[10px] text-green-600 flex items-center justify-center gap-0.5 mt-0.5">
                    ...
                    <div className="text-center p-2 bg-gray-50 rounded-lg flex flex-col justify-center">
                      <div className="text-base font-bold text-gray-900 leading-tight">{publishers.filter(p => p.enabled).length} Premium Sites</div>
                      <div className="text-xs text-gray-600 mt-0.5">Trust Network</div>
                    </div>
                  </div>
                  
                  {/* Performance indicators */}
                  <div className="mt-2.5 pt-2.5 border-t border-gray-100 grid grid-cols-3 gap-2.5 text-center">
                    <div>
        ...
        {visibleCards.metrics && (
          <div className="bg-white border-t border-gray-200 p-3 flex-shrink-0 shadow-lg animate-fadeIn">
            <div className="max-w-7xl mx-auto">
              <button 
